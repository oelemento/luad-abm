...
#SBATCH --mem=32G
#SBATCH --time=2:00:00
#SBATCH --output=logs/sbi_v6_combine_%j.out
#SBATCH --error=logs/sbi_v6_combine_%j.err
...
python gaglia_abm/runs/sbi_combine.py \
    --chunks-dir outputs/bayesian_inference_v6/chunks \
    --out outputs/bayesian_inference_v6 \
